  ...
  const content = (
    <div className="content">
      ...
      <p>
        ...
        graphics, logos, images, and software, is the property of Sanket Shetty
        or its content creators and is protected by copyright, trademark, and
        other intellectual property laws. You may not reproduce, distribute, or
        create derivative works from any content without express written
        permission.
      </p>
      ...
      <p>
        ...
        this site in any way that violates any applicable local, national, or
        international law or regulation.
      </p>

      <h4>4. User Contributions</h4>
      <p>
        If you submit or post content on this website, you grant Sanket Shetty a
        non-exclusive, royalty-free, perpetual, and fully sublicensable right to
        use, reproduce, modify, publish, and distribute such content. You are
        responsible for the content you submit and agree that it does not
      ...
      <p>
        ...
        practices of any third-party websites. You acknowledge and agree that
        Sanket Shetty shall not be responsible or liable, directly or
      ...
      <p>
        ...
        availability of the website or the information contained on it. Any
      ...
      <p>
        ...
        or in connection with your use of this website. This includes, but is
      ...
      <p>
        Sanket Shetty reserves the right to modify these Terms and Conditions at
        any time. Any changes will be effective immediately upon posting the
        updated terms on this website. Your continued use of the site after any
