...
const PrivacyPolicy = ({ open, onClose }) => {
  ...
  const content = (
    <div className="content">
      ...
      <ul>
        <li>
          <strong>Personal Data:</strong> While using our site, you may provide
          us with certain personally identifiable information that can be used
          to contact or identify you, such as your name, email address, and
          phone number.
        </li>
        <li>
          <strong>Usage Data:</strong> We may collect information on how the
          website is accessed and used. This Usage Data may include information
